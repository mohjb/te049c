places={
	...
	"features": [
{ "type": "Feature", "properties": { "scalerank": 0, "labelrank": 10, "featurecla": "Admin-0 capital", "name": "Kuwait", "nameascii": "Kuwait", "adm0name": "Kuwait", "adm0_a3": "KWT", "adm1name": "Al Kuwait", "iso_a2": "KW", "note": "Home", "latitude":29.17299367636762, "longitude":47.770777077707834, "changed": 4.0, "namediff": 0, "diffnote": "Changed scale rank.", "pop_max": 4465000, "pop_min": 4205961, "pop_other": 5148778, "rank_max": 12, "rank_min": 12, "geonameid": 108409.0, "meganame": "Al-Kuwait", "ls_name": "Kuwait", "ls_match": 1, "checkme": 0 }, "geometry": { "type": "Point", "coordinates": [ 47.770777077707834 , 29.17299367636762 ] } }
,
...
function initRemainingPlaces(){var places0={
//SAU:[45.0516647531573, 25.6331128978041,"Saudi Arabia","SA"] // [43.398392652124,25.259893111244978]
//,USA:[-97.95637198622273,40.454128003454606,"United States","US"]
CYM:[-81,19,"Cayman Islands","KY"]//19°20′N 81°24′W
//,IRQ:[43.398392652124, 33.874396628268,"Iraq","IR"]
//,IND:[76.94505494505495, 24.056597610029684,"India","IN"]
//,TUR:[30.584415584415584, 40.001134503047126,"Turkey","TR"]
,BHR:[49.675324675324674, 27.408718346547204,"Bahrain","BH"]
,OMN:[57.467532467532465, 22.104369952877093,"Oman","OM"]
//,ARE:[53.57142857142858, 24.253166994982926,"United Arab Emirates","AE"]
,QAT:[51.23376623376623, 26.366263943112013,"Qatar","QA"]
,JEY:[-3.362637362637363, 49.30880883711452,"Jersey","JE"]
,TUN:[9.692307692307693, 36.00749766531932,"Tunisia","TN"]
//,FRA:[1.3846153846153848, 47.47014259876448,"France","FR"]
//,EGY:[30.263736263736266, 30.042083637816763,"Egypt","EG"]
,SDN:[32.637362637362635, 19.278955157180555,"Sudan","SD"]
//,HKG:[122.43956043956045, 30.383948481875183,"Hong Kong","HK"]
//,KOR:[127.18681318681318, 36.32686762990563,"South Korea","KR"]
,JOR:[36.1978021978022, 31.064094926220353,"Jordan","JO"]
//,NLD:[5.340659340659341, 52.54854348648246,"Netherlands","NL"]
//,GBR:[-0.9890109890109889, 52.54854348648246,"United Kingdom","GB"]
//,CAN:[-102.26373626373626, 56.885022644639896,"Canada","CA"]
//,DEU:[9.692307692307693, 52.307320988231716,"Germany","DE"]
,MYS:[9.692307692307693, 52.307320988231716,"Malaysia","MY"]
//,IRN:[53.604395604395606, 33.406200586253725,"Iran","IR"]
,DZA:[2.5714285714285716, 30.383948481875183,"Algeria","DZ"]
//,MAR:[-7.318681318681319, 33.075328002018686,"Morocco","MA"]
,LBN:[35.80219780219781, 34.06417343571554,"Lebanon","LB"]
,PAK:[69.82417582417582, 31.064094926220353,"Pakistan","PK"]
,MRT:[-10.483516483516484, 21.871259614612644,"Mauritania","MR"]
,SYR:[37.78021978021978, 35.36486555009878,"Syria","SY"]
,NOR:[23.934065934065938, 69.91016881788353,"Norway","NO"]
//,IDN:[113.73626373626375, -0.5224207641110183,"Indonesia","ID"]
//,JPN:[138.65934065934067, 36.64493397815583,"Japan","JP"]
//,CHE:[7.714285714285714, 46.932583045058045,"Switzerland","CH"]
,IMN:[-5.736263736263736, 53.73493857398516,"Isle of Man","IM"]
,MLT:[13.64835164835165, 36.32686762990563,"Malta","MT"]
,MDV:[72.59340659340658, 6.190765619314675,"Maldives","MV"]
...
,DNK:[	9.501785,56.26392	,"Denmark","DK"]
//,ZAF:[,,"South Africa","ZA"]
,LUX:[	6.129583,	49.815273,"Luxembourg","LU"]
,VGB:[	-64.639968,	18.420695	,"Virgin Islands, British","VG"]
//,CHN:[,,"China, P.R.: Mainland","CN"]
}
for(var i in places0){var x= places0[i]
	places.features.push(
		...
		, "properties": {
			...
			, "scalerank": 0, "labelrank": 10, "featurecla": "Admin-0 capital"
			, "name": x[2], "nameascii":x[2], "adm0name":x[2], "adm0_a3": i, "adm1name": x[2]
			, "iso_a2": x[3], "note": null, "changed": 4.0, "namediff": 0, "diffnote": "Changed scale rank."
			, "pop_max": 4465000, "pop_min": 4205961, "pop_other": 5148778, "rank_max": 12
			, "rank_min": 12, "geonameid": 108409.0, "meganame": x[2], "ls_name": x[2]
			, "ls_match": 1, "checkme": 0 }
		, "geometry": { "type": "Point", "coordinates": [ x[0] , x[1] ] } })
}
}
initRemainingPlaces()