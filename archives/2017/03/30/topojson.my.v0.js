...
{	function t(t,e)
	{	function n(e)
		{var n=t.arcs[e],r=n[0],o=[0,0];return n.forEach(function(t){o[0]+=t[0],o[1]+=t[1]}),[r,o]
		}
	...
	{	function a(t){0>t&&(t=~t),(l[t]||(l[t]=[])).push(f)}
		...
		{	var f,l=[],d=
				...
				,MultiLineString:c
				,Polygon:c
				,MultiPolygon:function(t){t.forEach(c)}
				};
			s(r),
			l.forEach(3>arguments.length?
				function(t,e){u.push([e])}:
				function(t,e){o(t[0],t[t.length-1])&&u.push([e])}
			)
		}else for(var p=0,h=e.arcs.length;h>p;++p)
			u.push([p]);
	...
	{	function n(t,e)
		...
		function s(t)
		{var e=t.type,n="GeometryCollection"===e?{type:e,geometries:t.geometries.map(s)}
			:e in v?{type:e,coordinates:v[e](t)}
			:{type:null};
		...
		var u=t.transform
			...
			,p=u.translate[1]
			,h=t.arcs
			,v={Point:function(t){return o(t.coordinates)}
				,MultiPoint:function(t){return t.coordinates.map(o)}
				,LineString:function(t){return a(t.arcs)}
				,MultiLineString:function(t){return t.arcs.map(a)}
				,Polygon:function(t){return c(t.arcs)}
				,MultiPolygon:function(t){return t.arcs.map(c)}
			};
			return s(e)
	}
	function r(t,e)
	...
	{	function e(t,e)
		...
		function r(t,e){"GeometryCollection"===t.type?
			t.geometries.forEach(function(t){r(t,e)}):
		...
		var a=[]
			...
			,c={LineString:e
				,MultiLineString:n
				,Polygon:n
				,MultiPolygon:function(t,e){t.forEach(function(t){n(t,e)})}
			};
